...
df[["Дата погашения", "Дата размещения"]] = df[
    ["Дата погашения", "Дата размещения"]
].map(lambda x: pd.to_datetime(x, dayfirst=True))
df["Срок обращения"] = df["Дата погашения"] - df["Дата размещения"]
print(df[["Серия", "Объем выпуска", "Ставка купона", "Срок обращения"]])
