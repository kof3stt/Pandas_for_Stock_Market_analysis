...
df = (
    depo[["Банк", "Сумма, руб.", "Взвешенная ставка"]]
    .groupby("Банк", as_index=False)
    .sum()
)
df["Cредневзвешенная ставка"] = (df["Взвешенная ставка"] / df["Сумма, руб."]).round(2)
print(df[["Банк", "Сумма, руб.", "Cредневзвешенная ставка"]])
