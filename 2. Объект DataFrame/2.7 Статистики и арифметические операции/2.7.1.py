...
# print(interest_rates.iloc[interest_rates.loc[:, "Ставка"].idxmax(), 0])
# print(interest_rates.iloc[interest_rates.loc[:, "Ставка"].idxmin(), 0])
print(interest_rates["Страна"][interest_rates["Ставка"].idxmax()])
print(interest_rates["Страна"][interest_rates["Ставка"].idxmin()])
